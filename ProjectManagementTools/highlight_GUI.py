...
class highlight_extractor_frame(tk.Frame):
	...
	def create_widgets(self):
		...
		self.highlightExtractor = tk.Button(self,text="RUN",fg="green")
		...
		self.openExcel_FLAG = tk.Checkbutton(self,text="Open Excel",variable=self.FLAG_EXCEL_VAR)
	...
	def run_highlightExtractor(self):
		...
		self.progressBar = tk.Label(self,text="Running")
